...
>(({ className, ...props }, ref) => (
  <Overlay
    className={cn(
      "fade-in-0 data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 animate-in bg-black/80 data-[state=closed]:animate-out data-[state=open]:animate-in",
      className
    )}
    {...props}
    ref={ref}

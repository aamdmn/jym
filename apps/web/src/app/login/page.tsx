    ...
    <div className="flex h-screen flex-col items-center justify-center">
      <div className="w-full max-w-md space-y-6">
        <div className="text-start">
          <h1 className="font-medium font-serif text-2xl">Welcome to Jym</h1>
        ...
        <div className="space-y-4">
          <Button
            className="flex h-13 w-full items-center gap-3 font-medium text-base"
            disabled={isLoading}
            onClick={signInWithGoogle}
            size="lg"
          >
            <IconBrandGoogle className="size-6 fill-secondary stroke-none" />
